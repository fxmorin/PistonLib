...
public @interface ConfigValue {
    ...
    /**
     * Config options that are required to work
     *
     * @since 1.0.4
     */
    ...
    /**
     * This class makes sure that the config value is valid,
     * and converts string inputs to a valid type.
     *
     * @see Parser
     * @since 1.0.4
     */
    ...
    /**
     * On which environment types should the option be loaded.
     *
     * @since 1.0.4
     */
     ...
     * before being added to the Settings Manager.
     *
     * @see Observer
     * @since 1.0.4
     */
