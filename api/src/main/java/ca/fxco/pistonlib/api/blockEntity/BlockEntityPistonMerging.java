...
public interface BlockEntityPistonMerging {
     ...
     * @since 1.0.4
     */
    boolean pl$shouldStoreSelf(PLMergeBlockEntity mergeBlockEntity);
    ...
    /**
     * Runs when this block entity is merging with a {@link PLMergeBlockEntity}.
     *
     * @param mergeBlockEntity merged block entity
     * @param dir              direction its moving
     * @since 1.0.4
     */
    void pl$onMerge(PLMergeBlockEntity mergeBlockEntity, Direction dir);
     ...
     * @since 1.0.4
     */
    void pl$beforeInitialFinalMerge(BlockState finalState, Map<Direction, PLMergeBlockEntity.MergeData> mergedData);
     ...
     * @since 1.0.4
     */
    void pl$afterInitialFinalMerge(BlockState finalState, Map<Direction, PLMergeBlockEntity.MergeData> mergedData);
